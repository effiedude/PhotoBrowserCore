...
public interface InfoFlowJsonConstDef
{
    ...
    String PARAMxMEDIAxTYPE="type";
    String MEDIAxTYPExIMAGE="image";
    String MEDIAxTYPExVIDEO="video";
    String PARAMxIMAGExTYPE="imageType";
    String IMAGExTYPExGIF="gif";
    String IMAGExTYPExNORMAL="normal";
    String IMAGExTYPExLONG="long";
    String IMAGES="list";
